...
//    public static ArrayList<String> minionNames = new ArrayList<>();
    ...
    public Minion(String mana, String id, String cardType, String name, String price,
                  String targets, String numOfTargets, String friendOrEnemy,
                  String healthPoint, String attackPower, String attackType,
                  String attackRange, String specialPower, String actionTypes,
                  String locationOfTargets, String doesNotGetAttack, String activationTime,
        ...
        super(mana, id, cardType, name, price, targets, numOfTargets,
                ...
                attackRange, specialPower, actionTypes, locationOfTargets,imagePath,inField, numInShop);
...
//    }
    ...
    public void applyMinionSpecialPowerOnAttck(int x, int y){
